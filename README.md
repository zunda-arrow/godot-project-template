...
For example, if I wanted to start a player with certain cards in a card game, I could put the code to
do that in that function.


To write test that stays on your local system name the file `tests/<your_test_name>.local.gd`.
